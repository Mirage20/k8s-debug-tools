...
RUN apt-get update &&\
    DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends ca-certificates tcpdump curl wget telnet iputils-ping dnsutils net-tools netcat iptables &&\
